...
it('renders zero, negative and missing yield distinctly with real table rows',async()=>{
 const w=mount(Results,{props:{name:'例',result:{selection_mode:'filter_only',rows:[{code:'1',name:'零',simple_maturity_yield_pct:0},{code:'2',name:'负',simple_maturity_yield_pct:-12},{code:'3',name:'缺',simple_maturity_yield_pct:null}],excluded_rows:[],meta:{}}},global:{plugins:[ElementPlus]}});
 await flushPromises();
