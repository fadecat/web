...
from backend.api.routes import app_settings, cb_adjustment, cb_discussion, cb_index, cb_list, cb_screen, commodities, data_management, data_status, health, jisilu_accounts, portfolio, research, stock_dividend, style_rotation, valuation
...
def create_app() -> FastAPI:
    ...
    app.include_router(stock_dividend.router, prefix=prefix, tags=["stock-dividend"])
    app.include_router(cb_screen.router, prefix=prefix, tags=["cb-screen"])
    app.include_router(cb_discussion.router, prefix=prefix, tags=["cb-discussion"])
    app.include_router(cb_adjustment.router, prefix=prefix, tags=["cb-adjustment"])
